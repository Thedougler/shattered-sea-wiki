...
**Coordinates with:** `easy-to-roleplay`, `wiki-categorize`
...
**Coordinates with:** `prep-session`, `mercer-voice`, `sandbox-narrative`
...
**Coordinates with:** `prep-npc`, `easy-to-roleplay`, `mercer-voice`
...
**Coordinates with:** `mercer-voice`, `prep-npc`
...
**Coordinates with:** `mercer-voice`, `humanize-writing`

### `mercer-voice`
**Purpose:** Apply Mercer-style DM narrative voice to any content — scene descriptions,
NPC dialogue, session recaps, strong starts. Evocative, sensory, purposeful. Never purple
prose. Every sentence earns its place. Specific sensory details over generic adjectives.
**Trigger:** Any player-facing prose generation; "make this sound better"; NPC dialogue
that will be read aloud; scene descriptions for handouts.
**Coordinates with:** `easy-to-roleplay`, `humanize-writing`, `prep-scene`

### `easy-to-roleplay`
**Purpose:** Structure NPC content so it is maximally easy to portray at the table.
Generate clear voice notes, behavioral tics, speech patterns, decision-making heuristics.
Distill complex backstories into 2–3 table-ready traits. Every NPC should be runnable
in 5 seconds of review.
**Trigger:** Any NPC creation or expansion; "make [NPC] easier to run"; "give me voice
notes for [NPC]."
**Coordinates with:** `prep-npc`, `prep-scene`, `mercer-voice`
...
### `humanize-writing`
**Purpose:** Review and rewrite any AI-generated wiki or narrative content to read as
natural, human-authored prose. Remove AI tells: excessive qualifiers, flat affect,
over-structured parallel sentences, hollow filler phrases. Preserve all information.
**Trigger:** Any generated content that sounds robotic, over-formal, or AI-flavored;
final pass before sharing player-facing content.
**Coordinates with:** `mercer-voice`, `session-recap-write`
...
**Coordinates with:** `combat-data-extract`, `easy-to-roleplay`, `player-interest-tracker`

### `dm-voice`
**Purpose:** Generate content written in the DM's own voice — personal DM notes, prep
reminders, session reflections, planning commentary. Calibrate to the DM's documented
style, shorthand, and terminology. Content is intended for DM eyes only.
**Trigger:** "Write this as a DM note", "how would I phrase this for my own prep",
any content that should read as if the DM wrote it themselves.
**Coordinates with:** `prep-session`, `prep-encounter`
