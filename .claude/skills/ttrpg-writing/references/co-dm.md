...
- Update `content/hot.md` and append a concise entry to `content/log.md` after content writes.
- After all writes: `git add content/ && git commit -m "co-dm: <brief description>"`
- Update `content/index.md` when creating a new page.
