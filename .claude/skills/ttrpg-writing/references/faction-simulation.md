...
2. `content/hot.md`
3. `content/shattered-sea/situations/index.md`
...
Use `rg --files content | rg -i "slug-or-name"` and `rg -n "Exact Name"` to verify paths and inline mentions.
...
8. Refresh `content/hot.md` and append `content/log.md`.
...
- **`content/hot.md`:** active campaign state and recent activity
- **`content/log.md`:** concise chronological update
...
- `content/hot.md` and `content/log.md` were updated after writes.
