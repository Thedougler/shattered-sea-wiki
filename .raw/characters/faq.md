...
- auto-lint
subtype: faq
summary: Public FAQ for using the Shattered Sea campaign wiki, including where to
  start, how navigation-safety works, and how to use the wiki with a chatbot.
tags:
- reference
- setting
title: FAQ
...
After that, use [[campaign-overview|Campaign Overview]] as the dense reference page and [[content/shattered-sea/index|The Shattered Sea]] as the root navigation hub.
...
5. Any homebrew species page you are considering from [[content/shattered-sea/lore/species/index|Playable Species]]

You do not need to memorize the setting. You need a character with a reason to be aboard the *[[Saltwright|Saltwright]]*, a reason to cross dangerous water, and a problem that could follow them into port.

## What species can I play?

Standard 2024 species are available, plus the [[Shattered-Sea|Shattered Sea]] options in [[content/shattered-sea/lore/species/index|Playable Species]]:
...
- [[content/shattered-sea/index|The Shattered Sea]] — campaign hub
