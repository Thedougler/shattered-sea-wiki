---
title: Captain Barnaby Rook
type: monster
publish: false
created: '2026-04-14'
updated: '2026-05-16'
summary: CR 3 Dravosi Crown privateer captain. Boarding specialist with Parry reaction, Officer's Advantage, 3 legendary actions (Reposition, Cutlass Strike, Pistol Reload), and 3 lair actions (Arm the Guns, Fire the Guns, Call to Arms). Phase 3 boss of the Saltwright encounter.
tags:
- creature
- humanoid
- bestiary
...
> See [[Barnaby-Rook]] for full lore, appearance, and connections.
...
lair_actions:
  ...
  - desc: "Call to Arms. If Rook has been reduced below half his hit point maximum (60 hp), he calls out to all remaining crew aboard the Surety — deckhands, riggers, cooks — not just soldiers. Any willing crew not already in combat take up arms and emerge above deck. Up to 1d4+1 Dravosi Deckhands appear at the start of Rook's next turn in unoccupied spaces aboard the Surety."
```

## Related

- [[Barnaby-Rook]] — Full lore and DM notes
- [[HCS-Surety]] — His command vessel
- [[Dravosi-Deckhand]] — Subordinate crew
- [[Dravosi-Enforcer]] — Subordinate crew
- [[Scene-08-Encounter]] — Phase 3 boss
