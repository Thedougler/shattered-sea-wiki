...
actions:
  - name: "Multiattack"
    desc: "The dragon makes three Rend attacks. It can replace one attack with Repulsion Breath or Spellcasting to cast Guiding Bolt (level 2 version)."
  - name: "Rend"
    desc: "Melee Weapon Attack: +12 to hit, reach 10 ft. Hit: 16 (2d8 + 7) Slashing damage plus 5 (1d10) Lightning damage."
  - name: "Lightning Breath (Recharge 5-6)"
    desc: "DC 19 Dexterity saving throw (each creature in a 90-foot-long, 5-foot-wide line). On a failed save, 55 (10d10) Lightning damage. On a successful save, half damage."
  - name: "Repulsion Breath"
    desc: "DC 19 Strength saving throw (each creature in a 30-foot cone). On a failed save, the target is pushed up to 60 feet straight away from the dragon and has the Prone condition."
legendary_actions:
  - name: "Guiding Light"
  ...
  - name: "Thunderclap"
    desc: "DC 17 Constitution saving throw (each creature in a 20-foot-radius sphere centered on a point the dragon can see within 90 feet). On a failed save, 10 (3d6) Thunder damage and the target has the Deafened condition until the end of its next turn."
spells:
  - "Charisma spellcasting (spell save DC 17, +10 to hit with spell attacks). At will: Detect Magic, Guiding Bolt (level 2 version), Shapechange (Beast or Humanoid form only), Speak with Animals, Thaumaturgy. 1/day each: Detect Thoughts, Water Breathing."
```
