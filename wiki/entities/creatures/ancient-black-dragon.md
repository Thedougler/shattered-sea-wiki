...
created: 2026-04-25
updated: 2026-05-31
tags: [combat, homebrew, late-game]
sources:
  - XMM
  - Homebrew
...
actions:
  ...
  - name: "Acid Breath (Recharge 5-6)"
    desc: "DC 22 Dexterity saving throw (each creature in a 90-foot-long, 10-foot-wide line). On a failed save, 67 (15d8) Acid damage. On a successful save, half damage."
legendary_actions:
  - name: "Cloud of Insects"
    desc: "DC 21 Dexterity saving throw (one creature within 120 feet). On a failed save, 33 (6d10) Poison damage and the target has Disadvantage on saving throws to maintain Concentration until the end of its next turn. The dragon can't take this action again until the start of its next turn."
...
spells:
  - "Charisma spellcasting (spell save DC 21, +13 to hit with spell attacks). At will: Detect Magic, Fear, Melf's Acid Arrow (level 4 version). 1/day each: Create Undead, Speak with Dead, Vitriolic Sphere (level 5 version)."
```

## In the Shattered Sea

The oldest [[midchain|Midchain]] pilots know that [[aruhe|Aruhe]] is not avoided because of the [[grung-clans|Grung]]. The Grung don't go there either.
