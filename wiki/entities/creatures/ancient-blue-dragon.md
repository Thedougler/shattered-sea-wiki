...
actions:
  ...
  - name: "Lightning Breath (Recharge 5-6)"
    desc: "DC 23 Dexterity saving throw (each creature in a 120-foot-long, 10-foot-wide line). On a failed save, 88 (16d10) Lightning damage. On a successful save, half damage."
legendary_actions:
  - name: "Cloaked Flight"
...
spells:
  - "Charisma spellcasting (spell save DC 22). At will: Detect Magic, Invisibility, Mage Hand, Shatter (level 3 version). 1/day each: Scrying, Sending."
```
