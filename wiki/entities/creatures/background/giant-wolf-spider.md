...
actions:
  - name: "Bite"
    desc: "Melee Weapon Attack: +5 to hit, reach 5 ft. Hit: 5 (1d4 + 3) Piercing damage plus 5 (2d4) Poison damage."
```

## Habitat

Forest undergrowth and grassland. In the Shattered Sea, found in the [[crown-islands|Crown Islands]], [[ral-arn|Ral-Arn]], [[calders-tooth|Calder's Tooth]], and [[keth-naar|Keth-Naar]]. Doesn't web — runs fast.
