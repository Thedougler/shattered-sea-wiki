...
actions:
  ...
  - name: "Fist"
    desc: "Melee Weapon Attack: +9 to hit, reach 10 ft. Hit: 22 (3d10 + 6) Bludgeoning damage."
  - name: "Boulder Toss"
    desc: "The ape hurls a boulder at a point it can see within 90 feet. dex 17, each creature in a 5-foot-radius Sphere [Area of Effect]|XPHB|Sphere centered on that point. {@actSaveFail} 24 (7d6) Bludgeoning damage. If the target is a Large or smaller creature, it has the Prone|XPHB condition. {@actSaveSuccess} Half damage only."
bonus_actions:
  - name: "Leap"
