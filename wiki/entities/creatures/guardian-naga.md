...
actions:
  ...
  - name: "Poisonous Spittle"
    desc: "DC 16 Constitution saving throw (one creature the naga can see within 60 feet). On a failed save, 31 (7d8) Poison damage and the target has the Blinded condition until the start of the naga's next turn. On a successful save, half damage only."
  - name: "Spellcasting"
    desc: "Wisdom spellcasting (spell save DC 16). At will: Thaumaturgy. 1/day each: Clairvoyance, Cure Wounds (level 6), Flame Strike (level 6), Geas, True Seeing."
```

## Habitat

Ancient guardian of a jungle shrine in the [[midchain|Midchain]] interior. The [[verdant-teeth|Verdant Teeth]] hold ruins older than any colonial map; locals know which temples are not visited twice. Linked by rumor to the [[antheri-ruins|Antheri Ruins]].
