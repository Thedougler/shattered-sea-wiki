...
actions:
  ...
  - name: "Spectral Jaws"
    desc: "Melee or Ranged Spell Attack: +4 to hit, reach 5 ft. or range 120 ft. Hit: 11 (2d8 + 2) Force damage."
spells:
  - "WIS-based spellcasting (spell save DC 12). At will: Thaumaturgy. 2/day each: Hold Person, Tongues. 2/day each: Bless, Healing Word."
```
