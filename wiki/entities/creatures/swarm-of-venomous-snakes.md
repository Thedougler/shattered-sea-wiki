...
actions:
  - name: "Bites"
    desc: "Melee Weapon Attack: +6 to hit, reach 5 ft. Hit: 8 (1d8 + 4) Piercing damage, or 6 (1d4 + 4) Piercing damage if the swarm is Bloodied, plus 10 (3d6) Poison damage."
```

## Habitat

Disturbed nest or flooded burrow; the [[orak|Orak]] interior and the [[verdant-scatter|Verdant Scatter]] undergrowth harbour more than it shows. Rain-season flooding pushes these masses onto paths and into campsites without warning.
