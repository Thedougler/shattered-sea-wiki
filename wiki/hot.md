...
|---|---|---|---|
| [[dravosi-crown|Dravosi Crown]] | Rook is gone; Knighton is moving | Ships dispatched toward party route | Knighton's ships intercept or party enters Crown territory |
| [[the-passage|The Passage]] | Nona met; favor owed; Anzolo called off (maybe) | Anzolo still at sea — may make contact | Nona uses sending stone; Anzolo surfaces |

## Live Situations

| Situation | Status | Party Awareness | Next Beat |
|---|---|---|---|
| [[abyss-vision\|Abyss Vision — "Grow"]] | Active — something communicated with Perrin | Perrin only | First context that illuminates "Grow" |
| [[umberlees-message\|Umberlee's Message]] | Active — servant at Waveservant Shrine | Delmar + Crissdalynn | Delmar goes to the shrine (or doesn't) |
| [[nonas-favor\|Nona's Favor]] | Active — Perrin committed unconditionally | Perrin only | Nona uses the sending stone |
...
2. The Umberlee servant is still at the shrine. Delmar's water moment and her finding him specifically are both Umberlee pressure — converging.
3. Anzolo was in motion before the directive to call off. He may arrive anyway.
4. The 20 Simone vials surface before Calveno is done — someone finds them or JC is forced to explain.
