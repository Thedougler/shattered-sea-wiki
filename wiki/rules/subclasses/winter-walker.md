...
*Ranger subclass — Forgotten Realms: Heroes of Faerun (2024)*

Focuses on cold damage and sharing cold effects with enemies. Works with conventional DEX-based Ranger builds but rewards WIS-heavy builds via Cold Caster feat and Shillelagh option.
...
**Winter Walker Ranger Spells (Level 3+).** Always prepared: Ice Knife, Hold Person (3rd); Sleet Storm (5th); Cone of Cold (7th).

**Hunter's Rime (Level 5).** Gain THP = Ranger level when you cast Hunter's Mark.

**Fortifying Soul (Level 7).** 1/LR: heal one visible creature (1d8 + Ranger level). Advantage vs. Frightened.
