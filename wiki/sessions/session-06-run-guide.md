...
|---|---|---|---|
| [[calveno-beffa-grung-raid\|Grung Raid]] | Timeline ~1.5 days from Le Paludi compromise; 3 secondary sites + primary still live | Detonation fires on schedule, unopposed at the primary | Heavier sentry posture network-wide; work-crews moving powder faster |
...
> [!check] Insight — Passive (automatic)
...
> [!dm]
> **Do not confirm or deny the toxin connection.** [[simone-tabarnack|Simone]] is already confirmed to be supplying the [[dravosi-crown|Dravosi Crown]] with Grung toxin (her page) — how much the Crown itself knows is an open question, not yet answered anywhere. Knighton's silence here can plausibly be that; don't surface it — seed for later, not a reveal.
...
*Cut from the fade to the present: the party at Room 6. Rest decision, then a free push through the sewers. This is where Scene 3 drops in — at your mark, not on a trigger.*

> [!dm]
> **Land the rest as the obvious, wanted choice — don't harass them into it.** The fights are behind them and Ruma keeps them safe. Heroes' Feast expires during the rest, and Otar's kit assumes it's gone — why/what to say if asked: [[wiki/entities/places/dungeons/calveno-sewers-grung-magazines|dungeon file § Long Rest — Room 6]].
>
> **If they push on without resting:** legitimate. Heroes' Feast stays active into the climax — less poison-brutal, more resource-starved. Full handling: [[wiki/entities/places/dungeons/calveno-sewers-grung-magazines|dungeon file § Fight Modifiers — Primary Chamber]].
...
**Ruma covers the network, full stop.** She answers the pipe-click check-ins herself, in handler-register, the way she has since Session 05 — no detection clock, no spoof roll, no patrol inbound. Play it once as flavor if you like (she goes quiet, listens, taps back, exhales), then let it go. The old check-in-clock minigame is retired; don't reintroduce it.

**Open the scene on her, before anything else moves:** let the table sit with her for a minute — she's relieved to have people who don't just report barrel counts at her. Low-stakes banter, not a data dump. First line if you need one: *"You're back. Good — I was starting to run out of things to draw."*

> [!mechanic]
> Room 6 reads as the smart place to stop on its own — dry stone, oil-lamp warmth, two chokepoints, Ruma's desk as a barricade. Her line if you need it: *"You can sleep here. I'm not going anywhere."*
>
> **Heroes' Feast expires during this rest** — don't mention it or hint at the math; the payoff lands later, when Foul Miasma connects with no poison immunity to stop it. Why/when, plus the watch-by-watch rest narration: [[wiki/entities/places/dungeons/calveno-sewers-grung-magazines|dungeon file § Long Rest — Room 6]] — reflavor the "Warren runner" watch beat as Ruma herself, since she's actually in the room tonight.

### The Push — where they go

Once Room 6 is settled — rested or not — the party chooses where to head. Don't announce this as a decision point; just track which door they walk through. The dungeon's geography is a real menu: each secondary magazine has its own guardian, and the primary waits past Room 7. **Route choice no longer decides Catarina's arrival** — that's your call now (Scene 3), independent of which door they open.
...
**What she brings to the table:** independent corroboration of the party's intel, plus the two things she worked out that they may not have — the raid's real purpose is **mass extraction** (hundreds staged to move, not just a bombing), and there is **arcane work** down here at a scale she can't place. She doesn't know the number is 200–300, where the captives would go, or that the "working" is a summoning. Keep the circle and the Slaad off the table until Room 8.

> [!dm]
> **The Grung in the room — play it as pressure, not plot.** Catarina arrived to stop a *Grung* plot. One of the people she's about to fight beside is a Grung — [[jean-claude-tabarnack|Jean-Claude]], in a red beret and false moustache, maybe skin-dyed green. She has no idea he's an ally, and he cannot mask what he is (Mortis). Offer it, let the table decide:
> - She may not clock him mid-scene at all — a bereted three-foot figure standing *with* humans isn't the obvious read.
> - She may clock him and hesitate. Don't auto-fire Ragnetto at him — it targets hostiles, and he isn't one. If her player wants the misunderstanding, let her drive it.
> - JC can't sell a cover story to her any better than to anyone else — whatever the party says to vouch for him, he confirms flatly and strangely. That's the character, not a failure.
> - Her red line is harm and misuse, not species ([[catarina-davirelli|her page]]). A friendly Grung is dissonant with her *mission*, not with who she is.
> - This doesn't need to resolve tonight. "A Crown-contracted human and a Grung defector are fighting the same fight and haven't talked about it" carries fine into Session 07.

### Catarina in a fight — quick reference

*Now that she's in, here's her kit at speed. Full notes: [[catarina-primer|Catarina Primer]]; cannon/owl stat blocks: [[otar-the-foul|Otar the Foul § Encounter Adaptation]].*

- **Ragnetto (Eldritch Cannon).** Her spider-walking backpack construct. Tiny, AC 18, HP 25, immune to poison/psychic, can't be charmed/frightened/paralyzed. Force Ballista: ranged spell attack, 60 ft, 2d8 force (≈ +7). She commands it with a bonus action; can swap it to **Protector** (temp HP) if the party bleeds. **Never targets [[jean-claude-tabarnack|Jean-Claude]].**
- **Strix (clockwork owl).** [[clockwork-owl-familiar|Owl]] stat block — AC 11, HP 1, fly 60, Flyby, keen senses. Scouts, Helps a PC, or feeds her player intel. 1 HP: a stray AoE ends it — a gut-punch, not a rules problem. Let it land.
- **Catarina herself.** AC 16, HP 38, **Alert** (+5 init, can't be surprised, no unseen-attacker advantage against her — she acts early, so give the other PCs a pre-combat beat so she doesn't solo the opening round). Fire Bolt / Shocking Grasp; Flintlock backup; **Wand of Pyrotechnics is a fire source** — matters against Otar's regen. **No War Caster:** every hit while she concentrates is a flat CON save, no advantage — ordinary damage and grapples pressure her, not anti-magic gimmicks. High passive Investigation (18) / Insight (14): let her read scenes without asking for rolls.
...
- **[[otar-the-foul|Otar the Foul]]** (Phase 3, CR 12 recalibrated) — Foul Miasma, Entropic Regeneration (needs fire/acid to suppress — Catarina's Wand of Pyrotechnics is the party's innate answer), Chaos Pulse, Unstable Form, legendary and lair actions, all on the page.

Full phase mechanics — triggers, detonation DCs, the checklist — live in [[wiki/entities/places/dungeons/calveno-sewers-grung-magazines|dungeon file § Room 8]]; read this card straight down for narration, reach for the dungeon file for the numbers. Fight modifiers (Heroes' Feast gone, hidden passage, circle disruption) and the Warren's safety-valve Rattle: [[wiki/entities/places/dungeons/calveno-sewers-grung-magazines|dungeon file § Fight Modifiers — Primary Chamber]] and [[otar-the-foul|Otar the Foul § The Rattle — The Warren Fights Beside You]].
...
**Hook out:** pursuit of the *vethka* — Session 07.
...
- Ruma's route map and the trail-marker clues from Session 05 (builder's notation, red-caste markers, the "circle site") remain valid if not already spent — see [[wiki/entities/places/dungeons/calveno-sewers-grung-magazines|dungeon file § Three Clue Audit]].
...
|---|---|---|
| Strix noses through a grate and finds the party — a minute later the chase breaks out down the nearest tunnel | The party | Catarina's introduction (Scene 3) |
...
- **[[catarina-davirelli|Catarina]]:** tonight *is* her spotlight — Scenes 1 and 3 are both built around her table debut. Protect the flashback (don't let the party's turn interrupt the Knighton scene) and let her player drive the first-contact roleplay in Scene 3.
...
1. **Place the request.** Underground → collector tunnels (use [[wiki/entities/places/dungeons/calveno-sewers-grung-magazines|dungeon file]] topology). Surface/harbor → [[calveno-districts|District Layout]].
...
For drop-in combat: [[calveno-street-encounters|Street Encounters]].

## Possible Cliffhanger

- **Catarina just joined and the party's mid-push:** end on her first line at the cornered Grung, before the party's answered her.
...
- **When you dropped Scene 3, and how her player played first contact** — establishes her voice going forward.
- **How the JC/Catarina "Grung in the room" beat landed** — resolved, deferred, or still un-surfaced.
- Did the party take the Room 6 long rest? Heroes' Feast active or expired going into Room 8 — this changes Otar's difficulty.
- Which secondary sites were neutralized, which remain; was the primary found; was the circle disrupted; was Otar summoned.
...
- [[session-05-run-guide|Session 05 Run Guide]] — parent session; Otar/Solange full phase mechanics reused directly here
- [[wiki/entities/places/dungeons/calveno-sewers-grung-magazines|Calveno Sewer Magazines]] — full dungeon key
- [[catarina-davirelli|Catarina Da'Virelli]] — PC page, gear (Strix, Ragnetto), mechanics
...
- [[jean-claude-tabarnack|Jean-Claude Tabarnack]] — the Grung defector in the party; the Scene 3 tension
...
- [[bazzoth-the-steeped|Bazzoth]] (Beta), [[vashu-the-weeping-veil|Vashu]] + [[purple-caste-enforcer|Purple-Caste Enforcer]] (Gamma), [[ozzeth-the-twiceborn|Ozzeth]] + [[purple-caste-zealot|Purple-Caste Zealot]] (Delta) — secondary-site stat blocks. [[ozvok-the-vermillion-distiller|Ozvok]] is shelved for this run.
- [[otar-the-foul|Otar the Foul]], [[solange-barret|Solange Barret]] — full stat blocks; Encounter Adaptation (cannon/owl stats, staggered-entry fallback)
